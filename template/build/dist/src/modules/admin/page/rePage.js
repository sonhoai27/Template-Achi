...
export default (function (state, action) {
    ...
    switch (action.type) {
        ...
        case SUCCESS(ACTION_TYPES.API_LIST_PAGE_UI): {
            return __assign({}, state, { resListPageUI: action.payload.data });
        }
        //save content
        ...
        case SUCCESS(ACTION_TYPES.API_SAVE_CONTENT): {
            return __assign({}, state, { resSaveContent: action.payload.data });
        }
        default:
            return state;
    }
...
export var reListPageUI = function (idPage) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
...
export var reSaveContent = function (form) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch({
