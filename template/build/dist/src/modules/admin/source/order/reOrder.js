...
export default (function (state, action) {
    ...
    switch (action.type) {
        ...
        case SUCCESS(ACTION_TYPES.API_ORDER): {
            return __assign({}, state, { resListOrder: action.payload.data });
        }
        // list sche order
        ...
        case SUCCESS(ACTION_TYPES.API_LIST_SCHE_ORDER): {
            return __assign({}, state, { resListScheOrder: action.payload.data });
        }
        case (ACTION_TYPES.IS_SHOWING_MODAL_EXPORT): {
            return __assign({}, state, { isShowingModalExport: action.payload });
        }
        // list  order sche
...
var API_ORDER = API + 'source/order';
var API_LIST_SCHE_ORDER = API + 'source/sche/all';
var API_LIST_ORDER_BY_SCHE = API + 'source/order/sche/';
export var reListOrder = function (page) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
...
export var reListScheOrder = function () { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch({
...
export var reIsShowingModalExport = function (status) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch({
...
export var reListOrderBySche = function (idSche) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch({
