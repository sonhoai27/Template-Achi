            ...
            $(function () {
                $(".datepicker-month__blog").datepicker({
                    ...
                    onClose: function (dateText, inst) {
                        ...
                        _this.month($("#datepicker-month__blog").val());
                    }
                });
                $(".datepicker-week__blog").datepicker({
                    ...
                    onClose: function (dateText, inst) {
                        $(_this).datepicker("setDate", new Date(inst.selectedYear, inst.selectedMonth, 1));
                        _this.week($("#datepicker-week__blog").val());
                    }
                });
            });
        };
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "row margin-t-72" },
                React.createElement("div", { className: "col-sm-6" },
                    React.createElement("h3", null, "B\u00E0i vi\u1EBFt - blog"),
                ...
                React.createElement("div", { className: "col-sm-6" },
                    React.createElement("div", { className: "flex" },
                        ...
                        React.createElement("input", { id: "datepicker-week__blog", placeholder: "Ch\u1ECDn n\u0103m \u0111\u1EC3 xem", type: "text", className: "form-control datepicker-week__blog flex-2" })),
                ...
                React.createElement("div", { className: "col-sm-12 margin-t-72" },
                    React.createElement("div", { className: "flex" },
                        ...
                        React.createElement("input", { id: "datepicker-month__blog", placeholder: "Ch\u1ECDn n\u0103m \u0111\u1EC3 xem", type: "text", className: "form-control datepicker-month__blog flex-2" })),
