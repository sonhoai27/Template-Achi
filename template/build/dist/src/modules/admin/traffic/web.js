...
var Web = /** @class */ (function (_super) {
    ...
    function Web(props) {
        ...
        _this.datePickerYear = function () {
            $(function () {
                $(".datepicker-month__web").datepicker({
                    dateFormat: "yy/mm/dd",
                    inline: true,
                    changeMonth: true,
                    changeYear: true,
                    ...
                    onClose: function (dateText, inst) {
                        ...
                        _this.month($("#datepicker-month__web").val());
                    }
                });
                $(".datepicker-week__web").datepicker({
                    dateFormat: "yy/mm/dd",
                    inline: true,
                    changeMonth: true,
                    changeYear: true,
                    ...
                    onClose: function (dateText, inst) {
                        $(_this).datepicker("setDate", new Date(inst.selectedYear, inst.selectedMonth, 1));
                        _this.week($("#datepicker-week__web").val());
                    }
                });
            });
        };
        ...
        _this.week = function (day) {
            axios.post(API + "thong-ke/web/theo-tuan", {
        ...
        _this.month = function (day) {
            axios.post(API + "thong-ke/web/theo-thang", {
    ...
    Web.prototype.componentDidMount = function () {
        var _this = this;
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "row margin-t-72" },
                React.createElement("div", { className: "col-sm-6" },
                    React.createElement("h3", null, "To\u00E0n trang web"),
                    React.createElement("div", { className: "sh-card padding-16 min-height" },
                        ...
                        React.createElement("p", { className: "bold" }, "\u0110\u1ECBa ch\u1EC9 truy c\u1EADp nhi\u1EC1u nh\u1EA5t"),
                        React.createElement("ul", { style: { margin: 0, padding: 0, listStyle: "none" } }, this.state.web.list
                            ? this.state.web.list.map(function (element, index) {
                                return (React.createElement("li", { key: index },
                                    React.createElement("a", { href: element.traffic_url, target: "_blank" },
                                        element.traffic_url,
                                        " - ",
                                        element.counter)));
                            })
                ...
                React.createElement("div", { className: "col-sm-6" },
                    React.createElement("div", { className: "flex" },
                        ...
                        React.createElement("input", { id: "datepicker-week__web", placeholder: "Ch\u1ECDn n\u0103m \u0111\u1EC3 xem", type: "text", className: "form-control datepicker-week__web flex-2" })),
                ...
                React.createElement("div", { className: "col-sm-12 margin-t-72" },
                    React.createElement("div", { className: "flex" },
                        ...
                        React.createElement("input", { id: "datepicker-month__web", placeholder: "Ch\u1ECDn n\u0103m \u0111\u1EC3 xem", type: "text", className: "form-control datepicker-month__web flex-2" })),
