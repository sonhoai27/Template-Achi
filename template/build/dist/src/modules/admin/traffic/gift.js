...
var Gift = /** @class */ (function (_super) {
            ...
            $(function () {
                $(".datepicker-month__gift").datepicker({
                    ...
                    onClose: function (dateText, inst) {
                        ...
                        _this.month($("#datepicker-month__gift").val());
                    }
                });
                $(".datepicker-week__gift").datepicker({
                    ...
                    onClose: function (dateText, inst) {
                        $(_this).datepicker("setDate", new Date(inst.selectedYear, inst.selectedMonth, 1));
                        _this.week($("#datepicker-week__gift").val());
                    }
                });
            });
        };
    ...
    Gift.prototype.componentDidMount = function () {
        var _this = this;
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "row margin-t-72" },
                React.createElement("div", { className: "col-sm-6" },
                    React.createElement("h3", null, "Nh\u1EADn qu\u00E0"),
                ...
                React.createElement("div", { className: "col-sm-6" },
                    React.createElement("div", { className: "flex" },
                        ...
                        React.createElement("input", { id: "datepicker-week__gift", placeholder: "Ch\u1ECDn n\u0103m \u0111\u1EC3 xem", type: "text", className: "form-control datepicker-week__gift flex-2" })),
                ...
                React.createElement("div", { className: "col-sm-12 margin-t-72" },
                    React.createElement("div", { className: "flex" },
                        ...
                        React.createElement("input", { id: "datepicker-month__gift", placeholder: "Ch\u1ECDn n\u0103m \u0111\u1EC3 xem", type: "text", className: "form-control datepicker-month__gift flex-2" })),
