...
export default (function (state, action) {
    ...
    switch (action.type) {
        ...
        case SUCCESS(ACTION_TYPES.API_LIST_VIDEO_SOURCE): {
            return __assign({}, state, { resListVideoSource: action.payload.data });
        }
        // add video
        ...
        case SUCCESS(ACTION_TYPES.API_ADD_VIDEO_SOURCE_VIDEO): {
            return __assign({}, state, { resAddVideoSourceVideo: action.payload.data });
        }
        // update video
        ...
        case SUCCESS(ACTION_TYPES.API_UPDATE_VIDEO_SOURCE_VIDEO): {
            return __assign({}, state, { resUpdateVideoSourceVideo: action.payload.data });
        }
        // delete video
        ...
        case SUCCESS(ACTION_TYPES.API_DELETE_VIDEO_SOURCE_VIDEO): {
            return __assign({}, state, { resDeleteVideoSourceVideo: action.payload.data });
        }
        default: return state;
    }
});
var API_SOURCE_VIDEO = API + 'video-source';
export var apiListVideoSource = function (idSource) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
...
export var apiAddVideoSource = function (form) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch({
...
export var apiUpdateVideoSource = function (form, id) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch({
...
export var apiDeleteVideoSource = function (id) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch({
...
//# sourceMappingURL=reVideoSource.js.map