...
export default (function (state, action) {
    ...
    switch (action.type) {
        ...
        case SUCCESS(ACTION_TYPES.API_LIST_COUNTER): {
            return __assign({}, state, { resListCounter: action.payload.data });
        }
        ...
        case SUCCESS(ACTION_TYPES.API_CLIENT_GET_GIFT): {
            return __assign({}, state, { resClientGetGift: action.payload.data });
        }
        ...
        case SUCCESS(ACTION_TYPES.API_SEND_GIFT): {
            return __assign({}, state, { resAddSendGift: action.payload.data });
        }
        default:
            return state;
    }
});
var API_GOI_QUA_TANG = API + "goi-qua-tang";
export var reListCounter = function () { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
...
export var reClientGetGift = function (form, idGift) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch({
...
export var reAddSendGift = function (form, count) { return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dispatch({
...
//# sourceMappingURL=reSendGift.js.map