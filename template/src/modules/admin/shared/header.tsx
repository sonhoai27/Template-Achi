        ...
        <div className="navbar-default sidebar" role="navigation">
          <div className="sidebar-nav">
            ...
            <ul className="nav" id="side-menu">
              ...
              checkRule(
                ...
                <li>
                  ...
                  <ul className="nav nav-second-level collapse">
                    ...
                    <li>
                      <a
                        href={BASEURLADMIN + "source/contact"}
                    ...
                    checkRule(
                      ...
                      <li>
                        <a
                          href={BASEURLADMIN + "source/add-source"}
                          className="waves-effect"
                        >
              ...
              {checkRule(this.props.resCheckLogin.user.userRule, "ADMIN") ||
              checkRule(this.props.resCheckLogin.user.userRule, "NGUOI_DUNG") ||
              checkRule(
                this.props.resCheckLogin.user.userRule,
                "NGUOI_QUAN_LY"
              ) ? (
