...
class Source extends React.Component<{}, IState> {
    constructor(props) {
        super(props);
        this.state = {
            web: {},
        ...
        $(()=> {
            $(".datepicker-month__source").datepicker({
                ...
                onClose: (dateText, inst)=> {
                    ...
                    this.month($("#datepicker-month__source").val())
                }
            });
            $(".datepicker-week__source").datepicker({
                ...
                onClose: (dateText, inst)=> {
                    ...
                    this.week($("#datepicker-week__source").val())
                }
            });
        });
    };
                ...
                <div className="row margin-t-72">
                    ...
                    <div className="col-sm-6">
                        <div className="flex">
                            ...
                            <input
                                id="datepicker-week__source"
                                placeholder="Chọn năm để xem"
                                type="text"
                                className="form-control datepicker-week__source flex-2"
                            />
                        </div>
                    ...
                    <div className="col-sm-12 margin-t-72">
                        <div className="flex">
                            ...
                            <input
                                id="datepicker-month__source"
                                placeholder="Chọn năm để xem"
                                type="text"
                                className="form-control datepicker-month__source flex-2"
                            />
                        </div>
                        <div className="row">
                            <div className="col-xs-12">
