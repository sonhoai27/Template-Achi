...
class Web extends React.Component<{}, IState> {
    constructor(props) {
        super(props);
        this.state = {
            web: {},
        ...
        $(()=> {
            $(".datepicker-month__web").datepicker({
                ...
                onClose: (dateText, inst)=> {
                    ...
                    this.month($("#datepicker-month__web").val())
                }
            });
            $(".datepicker-week__web").datepicker({
                ...
                onClose: (dateText, inst)=> {
                    ...
                    this.week($("#datepicker-week__web").val())
                }
            });
        });
    };
                ...
                <div className="row margin-t-72">
                    ...
                    <div className="col-sm-6">
                        <div className="flex">
                            ...
                            <input
                                id="datepicker-week__web"
                                placeholder="Chọn năm để xem"
                                type="text"
                                className="form-control datepicker-week__web flex-2"
                            />
                        </div>
                    ...
                    <div className="col-sm-12 margin-t-72">
                        <div className="flex">
                            ...
                            <input
                                id="datepicker-month__web"
                                placeholder="Chọn năm để xem"
                                type="text"
                                className="form-control datepicker-month__web flex-2"
                            />
                        </div>
                        <div className="row">
                            <div className="col-xs-12">
