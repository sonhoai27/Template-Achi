          ...
          <div className="panel">
            <div className="panel-toolbar">
              ...
              <div className="panel-action-bar">
                <div
                    data-toggle="modal" data-target="#listElement"
                    className="btn btn-xs btn-info">Thêm Element mới</div>
              </div>
            </div>
            <div className="content-list-detail-ui">
              <ul className="detail-ui-element">{<ListElementOnDetailUI detail={this.props.resDetailUI.list}/>}</ul>
            </div>
          </div>
        </div>
        <ListElement/>
