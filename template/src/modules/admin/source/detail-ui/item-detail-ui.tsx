...
class ItemDetailUISource extends React.Component<Props, State> {
  state = {
    ...
    content_element_attribute_src: this.props.detailUI
            ...
            <div
              onClick={() =>
                this.saveContentElement({
                  ...
                  content_element_id_detail_ui: this.props.detailUI
                    .detail_ui_id,
      ...
      <div className="item-block" style={{ marginBottom: 0 }}>
        ...
        {!this.checkChild() ? (<>
            ...
            <label className="col-md-12">
              ...
              <div
                onClick={() => {
                  ...
                  this.props.reSetContentElement({
                    ...this.props.detailUI,
          ...
          <div className="xem-truoc-noi-dung">
                <div dangerouslySetInnerHTML={{__html: this.props.detailUI.content_element_data}}/>
          </div>
        </>) : ''}
          <div className="form-group">
            <label className="col-md-12">
        ...
        <div className="noi-dung">{!this.checkChild() ? this.renderNoiDung() : ""}</div>
      </div>
    );
  };
  generateContent = () => {
