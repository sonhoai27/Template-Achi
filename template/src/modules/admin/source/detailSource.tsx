...
class DetailSource extends React.Component<Props, State> {
  ...
  saveSource = () => {
    ...
    const tempDomImageBanner: any = document.getElementById(
      "img-banner-source"
    );
                ...
                checkRule(
                  ...
                  "NGUOI_QUAN_LY"
                    ...
                    to={
                      BASEURLADMIN +
                      "source/ui-source/" +
                      this.state.source.source_id_ui +
                      "/" +
                      this.props.match.params.id
                    }
                  >
                    <div className="btn btn-sm btn-primary">Landing Page</div>
                  </Link>
                ) : (
                  ""
                )}
                    ...
                    <div className="col-sm-12">
                      ...
                      >
                        ...
                        <option
                          value="0"
                          selected={
                            this.state.source.source_is_video == 0
                              ? true
                              : false
                          }
                        >
                        ...
                        <option
                          value="1"
                          selected={
                            this.state.source.source_is_video == 1
                              ? true
                              : false
                          }
                        >
                    ...
                    <div className="col-sm-12">
                      ...
                      >
                        ...
                        <option
                          value="0"
                          selected={
                            this.state.source.source_is_page == 0 ? true : false
                          }
                        >
                          Không
                        </option>
                        <option
                          value="1"
                          selected={
                            this.state.source.source_is_page == 1 ? true : false
                          }
                        >
                          Có
                        </option>
